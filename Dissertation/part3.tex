...
\begin{multline}
\displaystyle\sigma_{ij}=\frac{\beta_0e^2}{2Vm^2}\sum\limits_{\alpha
	,\beta ,\alpha _1 ,\beta _1, \atop \gamma ,\gamma _1 } \hat
{p}_{\alpha \beta}^{(i)} \hat {p}_{\alpha _1 \beta
	_1}^{(j)}\int\limits_{- \infty }^\infty {dt \left\{ \left\langle
	\gamma \right|\exp\left[\frac{it}{\hbar}\left(\hat
	{H}_0 + V\right)\right]\left|\alpha\right\rangle \right.}\times\\
...
{\sigma }_{ii}=\frac{{\beta }_0e^2}{2Vm^2_e}\sum_{\alpha }{{\left|{\hat{P}}^i_{\alpha \alpha }\right|}^2 n_{\alpha }\left(1-n_{\alpha }\right)}\\
...
\frac{1}{\tau_{\alpha}}=\frac{2\pi}{\hbar} \sum_{\gamma }{W_{\alpha \gamma }\delta \left({\varepsilon }_{\alpha }-{\varepsilon }_{\gamma }\right)}
\end{equation}
